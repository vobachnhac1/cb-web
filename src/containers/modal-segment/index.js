...
const ModalSegment = (props) => {
  ...
  const [segmentId, setSegmentId] = useState(record ? record.segmentId : "");
  const [topicId, setTopicId] = useState(record ? record.topicId : "");
  const [segmentName, setSegmentName] = useState(record ? record.segmentName : "");
  const [segmentColor, setSegmentColor] = useState(record ? record.segmentColor : "");
  ...
  useEffect(() => {
    initPage();
    setSegmentId(record ? record.segmentId : "")
    setTopicId(record ? record.topicId : "")
    setSegmentName(record ? record.segmentName : "")
    setSegmentColor(record ? record.segmentColor : "")
                    ...
                    <Row >
                     ...
                     <Row style={{ marginTop: 10 }}>
                        ...
                        <Col  {...layoutContent}>
                               ...
                               <Select  style={{ width: '100%' }} defaultValue="" onChange={(value)=> setTopicId(value)}>
                     ...
                     <Row style={{ marginTop: 10 }}>
                        ...
                        <Col  {...layoutContent}>
                            ...
                            <DatePicker value={inactived_date} onChange={(date) => setInactived_date(date)}/>
                        </Col>
                      </Row>
                  </Form>
      </Card>
